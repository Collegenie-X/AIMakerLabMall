...
class LessonInquirySerializer(serializers.ModelSerializer):
    """
    수업 문의 모델에 대한 직렬화 클래스
    
    수업 문의 객체를 JSON 형식으로 변환하거나 JSON 데이터를 수업 문의 객체로 변환합니다.
    사용자 정보를 중첩하여 표시합니다.
    """
    ...
    class Meta:
        ...
        fields = [
            ...
            'target_audience', 'preferred_date', 'participant_count'
        ]
